...
public class Aes {
	...
	/* La clef courte K utilisÃ©e aujourd'hui est formÃ©e de 16 octets nuls */
	...
	/* RÃ©sultat du TP prÃ©cÃ©dent : diversification de la clef courte K en une clef Ã©tendue W */
	...
	/* Le bloc Ã  chiffrer aujourd'hui: 16 octets nuls */
	...
	public static void main(String args[]) {
		...
		if(test) {
	        ...
	        System.out.println("Le bloc \"SB_State\" en entrée vaut : ") ;
	        ...
	        System.out.println("Le bloc \"SR_State\" en entrée vaut : ") ;
	        aes.afficher_le_bloc(aes.State) ;
	        aes.ShiftRows() ;
	        ...
	        System.out.println("Le bloc \"MC_State\" en entrée vaut : ") ;
	        aes.afficher_le_bloc(aes.State) ;
	        aes.MixColumns() ;
	        ...
	        System.out.println("Le bloc \"ARK_State\" en entrée vaut : ") ;
	        aes.afficher_le_bloc(aes.State) ;
	        aes.AddRoundKey(1);
	...
	public void afficher_le_bloc(byte M[]) {
        for (int i=0; i<4; i++) { // Lignes 0 Ã  3
            System.out.print("          ");
            for (int j=0; j<4; j++) { // Colonnes 0 Ã  3
	...
	/* Table de substitution dÃ©jÃ  utilisÃ©e lors du TP prÃ©cÃ©dent */
	...
	/* Fonction mystÃ©rieuse qui calcule le produit de deux octets */
	...
	/* Partie Ã  complÃ©ter pour ce TP */
	...
	public void ShiftRows(){
		...
		/* Rotation sur la première ligne d'une case vers la gauche */
		...
		/* Rotation sur la deuxième ligne de deux case vers la gauche */
		...
		/* Rotation sur la troisème ligne d'une case vers la droite */
	...
	public void AddRoundKey(int r){
		...
		/* On ajoute à chaque octet courant du bloc State, l'octet correspondant dans notre clef de ronde W */
